...
public class HumedadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        rootView = inflater.inflate(R.layout.fragment_humedad, container, false);
        ...
        if(hora>=18||hora<=7){
            ...
            textView = (TextView) rootView.findViewById(R.id.tv_tx_humedad_maxima);
            textView.setBackgroundResource(R.drawable.background_noche3);
            textView = (TextView) rootView.findViewById(R.id.tv_humedad_maxima);
            textView.setBackgroundResource(R.drawable.background_noche4);
            textView = (TextView) rootView.findViewById(R.id.tv_tx_humedad_minima);
            textView.setBackgroundResource(R.drawable.background_noche5);
            textView = (TextView) rootView.findViewById(R.id.tv_humedad_minima);
            textView.setBackgroundResource(R.drawable.background_noche6);
            textView = (TextView) rootView.findViewById(R.id.tv_tx_humedad_promedio);
            textView.setBackgroundResource(R.drawable.background_noche7);
            textView = (TextView) rootView.findViewById(R.id.tv_humedad_promedio);
    ...
    private void jsonParse(){
        String url = "http://arrau.chillan.ubiobio.cl:8075/ubbiot/web/mediciones/medicionesporintervalofechas/OcTxZlaUKI/VIbSnGKyLW/19052018/26052018";
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    textView = (TextView) rootView.findViewById(R.id.tv_humedad_maxima);
                    textView.setText(maximo+" %RH");
                    textView = (TextView) rootView.findViewById(R.id.tv_humedad_minima);
                    textView.setText(minimo+" %RH");
                    textView = (TextView) rootView.findViewById(R.id.tv_humedad_promedio);
                    String humedad = promedio/jsonArray.length()+" %RH";
                    textView.setText(humedad);
