...
public class RadiacionFragment extends Fragment {
     ...
     * @return A new instance of fragment RadiacionFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        rootView = inflater.inflate(R.layout.fragment_radiacion, container, false);
        ...
        if(hora>=18||hora<=7){
            ...
            textView = (TextView) rootView.findViewById(R.id.tv_tx_radiacion_maxima);
            textView.setBackgroundResource(R.drawable.background_noche3);
            textView = (TextView) rootView.findViewById(R.id.tv_radiacion_maxima);
            textView.setBackgroundResource(R.drawable.background_noche4);
            textView = (TextView) rootView.findViewById(R.id.tv_tx_radiacion_minima);
            textView.setBackgroundResource(R.drawable.background_noche5);
            textView = (TextView) rootView.findViewById(R.id.tv_radiacion_minima);
            textView.setBackgroundResource(R.drawable.background_noche6);
            textView = (TextView) rootView.findViewById(R.id.tv_tx_radiacion_promedio);
            textView.setBackgroundResource(R.drawable.background_noche7);
            textView = (TextView) rootView.findViewById(R.id.tv_radiacion_promedio);
    ...
    private void jsonParse(){
        String url = "http://arrau.chillan.ubiobio.cl:8075/ubbiot/web/mediciones/medicionesporintervalofechas/OcTxZlaUKI/8IvrZCP3qa/19052018/26052018";
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    textView = (TextView) rootView.findViewById(R.id.tv_radiacion_maxima);
                    textView.setText(maximo+" nm");
                    textView = (TextView) rootView.findViewById(R.id.tv_radiacion_minima);
                    textView.setText(minimo+" nm");
                    textView = (TextView) rootView.findViewById(R.id.tv_radiacion_promedio);
                    String radiacion = promedio/jsonArray.length()+" nm";
                    textView.setText(radiacion);
