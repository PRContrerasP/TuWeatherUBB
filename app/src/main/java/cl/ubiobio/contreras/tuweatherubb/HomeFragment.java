...
public class HomeFragment extends Fragment {
    ...
    private void jsonParse(){
        String url = "http://arrau.chillan.ubiobio.cl:8075/ubbiot/web/mediciones/medicionespordia/OcTxZlaUKI/E1yGxKAcrg/26052018";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0;i<jsonArray.length();i++){
                        ...
                        System.out.println("Fecha: "+fecha+" Hora: "+hora+" valor: "+valor);
